...
urlpatterns = [
	...
	path('article/<str:article_type>/<int:pk>/', views.ArticleDetailView.as_view(), name='article_detail'),
	path('article/<str:article_type>/<int:article_id>/comment/', views.add_comment, name='add_comment'),
]